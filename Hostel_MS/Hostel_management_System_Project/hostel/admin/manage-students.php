				...
				<div class="row">
					<div class="col-md-12">
						<h2 class="page-title" style="margin-top:4%">Manage Registred Students</h2>
							<a href="unregistered.php" >Manage All students</a>
							</br>
							</br>
...
while($row=$res->fetch_object())
	  {
	  	$ret1="select * from userregistration where id='$row->id1'";
...
<td>
<a href="javascript:void(0);"  onClick="popUpWindow('http://localhost/project/Hostel_management_System_Project/hostel/admin/full-profile.php?id=<?php echo $row->emailid;?>');" title="View Full Details"><i class="fa fa-desktop"></i></a>&nbsp;&nbsp;
