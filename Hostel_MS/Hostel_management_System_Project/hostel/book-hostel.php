...
$query="insert into  registration(roomno,seater,feespm,foodstatus,stayfrom,duration,course,emailid,pmntAddress,pmntCity,pmnatetState,pmntPincode,id1) values(?,?,?,?,?,?,?,?,?,?,?,?,?)";
$stmt = $mysqli->prepare($query);
$rc=$stmt->bind_param('iiiisisssssii',$roomno,$seater,$feespm,$foodstatus,$stayfrom,$duration,$course,$emailid,$paddress,$pcity,$pstate,$ppincode,$aid);
$stmt->execute();
echo"<script>alert('Student Succssfully register');</script>";
}

 $select=mysqli_query($mysqli,"select * from files");
...
<body>
	...
	<div class="ts-main-content">
		...
		<div class="content-wrapper">
          ...
          echo"<a href='admin/file/$row1[1]' target='_blank' ><span class='glyphicon glyphicon-download'></span><em>Hostel rules</em></a><br>";

      }

      ?>
      			<label>Read Above file before booking hostel</label>
...
$uid=$_SESSION['login'];
			...
			<a href="room-details.php">click here to check room details
				<?php }
				else
				{
							//echo "";			
