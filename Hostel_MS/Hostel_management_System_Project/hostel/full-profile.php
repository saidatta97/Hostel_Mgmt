...
// Check connection
$ret1= mysqli_query($con,"SELECT * FROM userregistration where email = '".$_GET['id']."'");
...
<?php 
		 ...
		 $ret= mysqli_query($con,"SELECT * FROM registration where emailid = '".$_GET['id']."'");
			...
			<tr>
			  <td colspan="2"  class="font"><?php echo ucfirst($row1['firstName']);?> <?php echo ucfirst($row1['lastName']);?>'S <span class="font1"> information &raquo;</span> </td>
  </tr>
			<tr>
...
<tr>
<td width="12%" valign="top" class="heading">PR no: </td>
<td class="comb-value1"><?php echo $row1['regNo'];?></td>
</tr>

<tr>
<td width="12%" valign="top" class="heading">First Name: </td>
<td class="comb-value1"><?php echo $row1['firstName'];?></td>
</tr>

<tr>
<td width="12%" valign="top" class="heading">Middle name: </td>
<td class="comb-value1"><?php echo $row1['middleName'];?></td>
</tr>

<tr>
<td width="12%" valign="top" class="heading">Last: </td>
<td class="comb-value1"><?php echo $row1['lastName'];?></td>
</tr>

<tr>
<td width="12%" valign="top" class="heading">Gender: </td>
<td class="comb-value1"><?php echo $row1['gender'];?></td>
</tr>

<tr>
<td width="12%" valign="top" class="heading">Contact No: </td>
<td class="comb-value1"><?php echo $row1['contactNo'];?></td>
</tr>
